...
There are, however, a handful of studies that show developmental change in the mutual exclusivity effect by testing more than a couple age groups within the same experiment (e.g., Bion et al., 2013; Halberda, 2003; W. E. Merriman, 1986). For example, @halberda2003development tests 14- 16- and 17- mo in the ME paradigm, and finds a pattern of developmental change: 14-mo children were biased to select the familiar object, 16-mo were at chance, and 17-mo were biased to select the novel object, demonstrating the ME effect. While multi-age-group studies such as this  provide clear evidence *that* there is a greater propensity to make the ME inference with development, they do not provide the type of quantitative description of its developmental trajectory of the effect that could provide an important constraint on theories of ME. 
 
What is responsible for the observed developmental change in the ME effect? One potential cause is a child's increasing linguistic experience. With greater linguistic experience, children are more likely to have stronger representations of the familiar word in the ME task and should therefore be more likely to map the novel word onto the novel referent if they have an ME bias [@bion2013fast; @Grassmann_2015]. Relatedly, stronger representations of the familiar word might make children more likely to make the metacognitive judgement that the novel word is unfamiliar [@hartin2016preexposure; @slocum2018metacognitive]. Linguistic experience might also support the ME inference by giving the child more data that could be used to induce the lexical regularity [@merriman1989mutual; @merriman1986some; @lewis2013b]. One source of evidence for this proposal comes from the fact that children learning multiple languages show a weaker ME bias relative to monolinguals, perhaps because the lexical regularity is weaker in their linguistic input [@byers2009monolingual; @Houston_Price_2010; @Byers_Heinlein_2013]. The link between linguistic experience and the ME effect, over and above age, has been demonstrated in a number of small-scale studies through correlational analyses [@Graham_1998; @bion2013fast; @lederberg2008word], but without a clear description of the developmental trajectory of the effect it is difficult to make strong inferences about the causal role of linguistic experience.
...
Both of these accounts -- ME contraint and N3C -- do not have an obvious role for the developmental and experiential effects we have documented here. Since even young children are posited to have some bias, on such a theory, developmental effects on this kind of theory would be primarily generated by changes in downstream, performance-based factors. A range of factors have been proposed, such as the ability to process lexical items [@bion2013;@halberda2003development], ability to coordinate multiple labels [@merriman1986some;@merriman1989mutual], and general metacognitive abilities [@merriman1986some;@merriman1989mutual]. Further, experience-based effects such as those observed in our Experiment 2 could be the result of individual children simply failing to access individual lexical representations. In sum, these theories can only explain the observed developmental and experiential effects by appealing to the interaction of contraints and biases with other cognitive phenomena. 

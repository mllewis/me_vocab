...
Given the range of possible mechanisms producing experience-driven developmental change, a description of the developmental trajectory of the effect is needed in order to sufficiently constrain theories. There are a handful of studies that show developmental change in the mutual exclusivity effect by testing more than a couple age groups within the same experiment (e.g., Bion et al., 2013; Halberda, 2003; Merriman, 1986). For example, @halberda2003development tested 14- 16- and 17- mo in the ME paradigm, and found a pattern of developmental change: 14-mo children were biased to select the familiar object, 16-mo were at chance, and 17-mo were biased to select the novel object, demonstrating the ME effect.

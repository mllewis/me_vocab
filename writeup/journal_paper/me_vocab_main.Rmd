...
my_citations <- cite_r(file = "r-references.bib", 
                       ...
                       withhold = FALSE,
                       footnote = TRUE)
options(citr.parent_documents = "me_vocab_main.Rmd") # this allows you to use citr from child rmds
```

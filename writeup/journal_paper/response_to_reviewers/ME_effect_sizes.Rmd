...
Note discrepancy with Metalab.

Issues to deal with:

* Wall paper - include or not? (critical task is by touch only)
* Law & Edwards  include? I vote no (weird analysis)
* deal with repeated trials
* deal with eyetracking measure (see Kalashnikova et al. (2016 First Lang))
* do we want to impute for 1 trial conditions?
* do we want to impute for missing sds...I vote no, in large part because I didn't code lots of cases where it was clear that no es could be calculated. (e.g. Vincent-Smith et al. (1974))
...
Thank you for pointing me to this paper. I was able to email the author to get the raw data for this study. 

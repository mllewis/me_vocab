---
title: Checking ME effects sizes from Merrriman
subtitle: 
date: "`r Sys.Date()`"
output:
  html_document:
...
We included two conditions in Experiment 1A ("no cues/gaze" and "consistent").
...
This paper unfortunately does not report raw mean and standard deviations of proportion novel object selections in an form in either the text or the figure. I've emailed the first author in the hopes of obtaining this information.
...
Thank you for this suggestion. We have simulated the distribution for the Mervis and Bertrand, Study 1 paper and included this condition in the database (estimate SD = .42).

[Early lexical acquisition and the vocabulary spurt: A response to Goldfield & Reznick. - need to find this]
```{r}
ma_c %>%
...
[we could consider imputaiton here from other conditions]
...
[emailed author; if not available...do we want to impute from other conditions?]
...
There are three other papers by Kalashnikova and colleagues that should be added to the meta-analysis:
...
Kalashnikova, M., Mattock, K., & Monaghan, P. (2015). The effects of linguistic experience on the flexible use of mutual exclusivity in word learning. Bilingualism: Language and Cognition, 18(4), 626-638.
Kalashnikova, M., Escudero, P., & Kidd, E. (2018). The development of fast‐mapping and novel word retention strategies in monolingual and bilingual infants. Developmental science, 21(6), e12674.""

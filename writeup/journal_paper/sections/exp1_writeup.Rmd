...
exp1_complete <- exp1 %>%
  ...
  mutate(age_bin = as.factor(case_when(age_months >= 36 ~ "2-yo", 
                             TRUE ~ "3-yo"))) 
...
\begin{table}[]
\centering
\caption{Design for each of the four trial types. "N" indicates a novel referent and "F" indicates a familiar referent. Each test trial involved two displays. The first introduced an object and its label unambiguously. The second presented two objects and a single label and children were asked to identify the target referent. }
\label{my-label}

...
```{r, fig.width=5, fig.height =3.5, fig.pos = "!t", fig.cap = "Accuracy data for three age groups across three different conditions in Experiment 2. Conditions varied by the number of times the child observed an unambiguous novel label applied to the familiar object prior to the critical ME trial. The dashed line corresponds to chance. Ranges are 95\\% confidence intervals."}
mss <- e2_clean %>%

...
These data provide evidence that language-specific knowledge influences the magnitdue of the ME bias, consistent with the experimental work with multilinguals. 
...
To summarize our meta-analytic findings, we find a robust ME effect in each of the three populations we examined, as well as  evidence that the magnitude of this effect increases across development. We also identified several factors that moderated the effect. Specifically, we  we find that the ME effect is larger (1) for children with larger vocabularies, (2) in the canonical Familiar-Novel paradigm compared to the Novel-Novel paradigm, though both designs show roughly the same developmental trajectory, and (3) for monolinguals relative to monolinguals.

...
Finally, we examine a third-population of participants: non-typically developing children. This group includes a heterogenous sample of children with diagnoses including Autism-Spectrum Disorder (ASD), Mental Retardation, Williams Syndrome, Late-Talker, Selective Language Impairment, and deaf/hard-of-hearing These populations are of theoretical interests because they allow us to observe how impairment to a particular aspect of cognition influences the magnitude of the disambiguation effect. For example, children with ASD are thought to have impaired social reasoning skills [e.g., @phillips1998understanding]; thus, if children with ASD are able to succeed on disambiguation tasks, this suggests that social reasoning skills are not necessary to making a disambiguation inference.
